...
```r
seed <- as.numeric(as.Date("2015-06-14"))
set.seed(seed)
...
![](PML_Assignment_Vasanth_files/figure-html/histGroup-1.png) 

```r
histGroup(DTrainCS, "[^(fore)]arm")
```

![](PML_Assignment_Vasanth_files/figure-html/histGroup-2.png) 

```r
histGroup(DTrainCS, "dumbbell")
```

![](PML_Assignment_Vasanth_files/figure-html/histGroup-3.png) 

```r
histGroup(DTrainCS, "forearm")
```

![](PML_Assignment_Vasanth_files/figure-html/histGroup-4.png) 
...
##    2    0.9852525  0.9813406  0.002262739  0.002860242
##   27    0.9859073  0.9821711  0.002070603  0.002617589
##   52    0.9797117  0.9743334  0.003537582  0.004469399
## 
...
## 
##                      Class: A Class: B Class: C Class: D Class: E
## Sensitivity            0.9982   0.9901   0.9846   0.9876   0.9951
## Specificity            0.9984   0.9970   0.9960   0.9988   0.9998
## Pos Pred Value         0.9960   0.9875   0.9811   0.9937   0.9993
## Neg Pred Value         0.9993   0.9976   0.9968   0.9976   0.9989
## Prevalence             0.2845   0.1935   0.1744   0.1639   0.1838
## Detection Rate         0.2840   0.1916   0.1717   0.1619   0.1829
## Detection Prevalence   0.2851   0.1940   0.1750   0.1629   0.1830
## Balanced Accuracy      0.9983   0.9936   0.9903   0.9932   0.9975
```
...
## pitch_forearm          56.82
## yaw_belt               52.45
## magnet_dumbbell_z      43.50
## pitch_belt             42.35
## roll_forearm           40.50
## magnet_dumbbell_y      40.27
## accel_dumbbell_y       21.13
## roll_dumbbell          18.20
## accel_forearm_x        18.06
## magnet_dumbbell_x      17.57
## magnet_belt_z          15.28
## magnet_forearm_z       13.67
## accel_dumbbell_z       13.50
